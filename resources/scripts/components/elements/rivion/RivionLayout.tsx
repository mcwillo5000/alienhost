...
import NodeAnnouncementBanner from '@/components/dashboard/NodeAnnouncementBanner';

interface RivionLayoutProps {
    children: React.ReactNode;
}

export default ({ children }: RivionLayoutProps) => {
        ...
        <div className="rivion-layout-wrapper">
            ...
            <div className="rivion-content-wrapper">
                ...
                <SidebarNavigation 
                    ...
                    type={isServerPage ? "server" : "dashboard"}
                />
                ...
                <div className="rivion-main-content">
                    ...
                    <div className="rivion-page-content">
                        ...
                        {isServerPage && <NodeAnnouncementBanner />}
                        {children}
                    </div>
                </div>
            </div>
