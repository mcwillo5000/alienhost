...
@section('content-header')
    <h1>Create Advertisement<small>Add a new advertisement</small></h1>
    <ol class="breadcrumb">
                ...
                <form action="{{ route('admin.advertisements.store') }}" method="POST">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="name" name="name" value="{{ old('name') }}" placeholder="e.g., Hosting Advertisement" required>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="nest_id" name="nest_id" required>
                                ...
                                @foreach($nests as $nest)
                                    <option value="{{ $nest->id }}" {{ old('nest_id', 1) == $nest->id ? 'selected' : '' }}>
                                        {{ $nest->name }}
                                    </option>
                                @endforeach
                            </select>
                            ...
                            <div id="commands-container" style="max-width: 100%; overflow-x: auto;">
                                <div class="command-row" style="margin-bottom: 10px;">
                                    <div class="input-group" style="display: table; width: 100%;">
                                        <input type="text" class="form-control command-input" name="commands[]" value="{{ old('commands.0', 'say This server is hosted by YourHosting') }}" placeholder="say Your message here" style="display: table-cell; width: 100%;" required>
                                        <span class="input-group-btn" style="display: table-cell; width: 1%; white-space: nowrap; vertical-align: middle;">
                                            <button type="button" class="btn btn-danger remove-command" style="display: none; white-space: nowrap;">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="interval_minutes" name="interval_minutes" value="{{ old('interval_minutes', 30) }}" min="1" max="1440" required>
                    ...
                    <div class="box-footer">
                        ...
                        <button type="submit" class="btn btn-primary pull-right">Create Advertisement</button>
                    </div>
                </form>
            </div>
        </div>
